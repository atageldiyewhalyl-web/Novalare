import { CreditCard, Building, Download, AlertCircle, Users as UsersIcon, Building2 } from 'lucide-react';
...
export function Settings() {
  ...
  const [activeTab, setActiveTab] = useState<'billing' | 'team' | 'integrations'>('billing');
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your plan, billing, and team</p>
      </div>
