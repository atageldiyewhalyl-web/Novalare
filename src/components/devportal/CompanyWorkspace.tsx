...
import { Building, Settings, Archive, FileText, TrendingUp, Landmark, Users, Calendar, Upload, CheckCircle2, Circle, Download, ExternalLink, Trash2, Mail } from 'lucide-react';
            ...
            {workflows.map((workflow) => {
              ...
              return (
                <Card 
                  ...
                  onClick={() => onNavigate(workflow.id, { companyId })}
                >
                  <CardHeader>
