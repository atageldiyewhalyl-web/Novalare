...
const statements: Statement[] = [
  ...
  },
  {
    ...
    text: "No two firms work the same way. That's why every workflow in Novalare bends to your process, not the other way around.",
...
export const PhilosophySection = () => {
  return (
    <section
      className="relative w-full px-4 md:px-6 lg:px-8 py-32 md:py-40 lg:py-48"
      style={{ zIndex: 1 }}
    >
