...
export function HeroValueSection() {
  ...
  return (
    <section className="relative w-full px-4 sm:px-6 md:px-12 lg:px-20 py-12 md:py-16 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative rounded-2xl p-5 md:p-6 backdrop-blur-sm transition-all duration-500"
              style={{
          ...
          <div className="lg:col-span-4 flex items-center justify-center lg:justify-end">
            ...
            >
              <button
                ...
                className="group inline-flex items-center justify-center gap-3 px-7 py-3.5 rounded-full transition-all duration-300 hover:scale-105 active:scale-95 w-full lg:w-auto"
                style={{
