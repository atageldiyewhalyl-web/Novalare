        ...
        >
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              ...
              className="group p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-indigo-500/30 transition-all duration-300"
              aria-label="Previous workflow"
            >
              <ChevronLeft className="w-6 h-6 text-white/70 group-hover:text-indigo-400 transition-colors" strokeWidth={2.5} />
            </button>
            ...
            >
              <ChevronRight className="w-6 h-6 text-white/70 group-hover:text-indigo-400 transition-colors" strokeWidth={2.5} />
            </button>
          </div>
