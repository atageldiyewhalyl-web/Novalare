...
import { Upload, FileText, Loader2, ArrowLeft, CheckCircle, AlertCircle, Download, Clock, DollarSign, Target, XCircle, ChevronDown, ChevronUp } from "lucide-react";
...
const PROCESSING_STAGES: { stage: ProcessingStage; label: string; icon: string; duration: number }[] = [
  ...
  { stage: 'parsing', label: 'Parsing invoices...', icon: '📖', duration: 2000 },
  { stage: 'matching', label: 'AI matching invoices...', icon: '🔗', duration: 4000 },
          ...
          <div className="max-w-4xl mx-auto">
              ...
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8">
                  <div className="text-center mb-8">
                    ...
                    <h3 className="text-2xl text-white mb-2">Processing AP Reconciliation</h3>
                    <p className="text-purple-200">AI is analyzing your invoices</p>
                  </div>
            ...
            {result && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-3xl font-bold text-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        {result.summary.amount_mismatches_count}
                      </span>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-red-500/10 to-rose-500/10 border border-red-500/20 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-3xl font-bold text-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        {result.summary.missing_invoices_count}
                      </span>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-3xl font-bold text-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        {result.summary.internal_only_count}
                      </span>
                    </div>
                ...
                {/* Missing Invoices */}
                {result.missing_invoices.length > 0 && (
                ...
                {result.internal_only_invoices.length > 0 && (
