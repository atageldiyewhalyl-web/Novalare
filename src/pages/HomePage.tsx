...
import { TrendingDown, DollarSign, PiggyBank, Clock, Zap, Timer, Moon, Sun, CloudMoon, Users, Heart, Star, FileText } from "lucide-react";
...
export function HomePage() {
  ...
  return (
    <div className="relative bg-black min-h-screen overflow-x-hidden">
      ...
      <section id="demos" className="relative w-full py-16 md:py-24 flex items-center justify-center px-4">
        <div className="max-w-5xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              <button
                ...
                className="group inline-flex items-center justify-center gap-3 px-6 md:px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 active:scale-95 relative w-full"
                style={{
              ...
              >
                <FileText className="w-5 h-5 md:w-6 md:h-6 text-white transition-transform duration-300 group-hover:scale-110" strokeWidth={2.5} />
                <span
              ...
              <p 
                className="text-purple-200/80 mt-3 text-center px-2"
                style={{
            ...
            >
              ...
              <p 
                className="text-cyan-200/80 mt-3 text-center px-2"
                style={{
                  fontSize: 'clamp(12px, 1.3vw, 14px)',
                  fontWeight: '500',
                  fontFamily: "'Manrope', sans-serif",
            ...
            >
              ...
              <p 
                className="text-emerald-200/80 mt-3 text-center px-2"
                style={{
                  fontSize: 'clamp(12px, 1.3vw, 14px)',
                  fontWeight: '500',
                  fontFamily: "'Manrope', sans-serif",
          ...
          <div className="mt-8 flex justify-center">
            ...
            >
              ...
              <p 
                className="text-orange-200/80 mt-3 text-center px-2"
                style={{
                  fontSize: 'clamp(12px, 1.3vw, 14px)',
                  fontWeight: '500',
                  fontFamily: "'Manrope', sans-serif",
      ...
      <div ref={helixSectionRef} className="relative">
        ...
        {/* SECTION 9: Services Section - NOW INSIDE THE ANIMATION CONTAINER */}
        <div id="services">
          <ServicesSection ref={servicesSectionRef} />
        </div>

        {/* SECTION 10: Workflow Section - NOW INSIDE THE ANIMATION CONTAINER */}
        <div id="workflow">
