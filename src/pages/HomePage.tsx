...
export function HomePage() {
  ...
  return (
    <div className="relative bg-black min-h-screen overflow-x-hidden">
      ...
      {/* Invoice Demo Button Section - Centered in Black Space */}
      <section className="relative w-full py-16 md:py-24 flex items-center justify-center px-4">
        <motion.div
        ...
        >
          <button
            ...
            className="group inline-flex items-center justify-center gap-3 px-8 md:px-10 py-4 md:py-5 rounded-full transition-all duration-300 hover:scale-105 active:scale-95 relative"
            style={{
          ...
          >
            <FileText className="w-6 h-6 md:w-7 md:h-7 text-white transition-transform duration-300 group-hover:scale-110" strokeWidth={2.5} />
            <span
            ...
            >
              Try Invoice Extraction Demo
            </span>
          </button>
          
          <p 
            className="text-purple-200/80 mt-4 text-center px-4"
            style={{
          ...
          >
            See our AI in action - Upload an invoice and get structured data instantly
          </p>
        </motion.div>
      </section>
